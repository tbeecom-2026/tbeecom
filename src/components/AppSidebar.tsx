import { LayoutDashboard, FileText, Contact, Activity, LogOut, Building2, Settings, Store, Radar, Calculator, BarChart3 } from "lucide-react";
  ...
  return (
    <Sidebar collapsible="icon">
      ...
      <SidebarFooter className="border-t border-sidebar-border pt-4">
        {!collapsed && <p className="text-xs text-sidebar-foreground/60 px-2 truncate">{user?.email}</p>}
        <SidebarMenu>
          <SidebarMenuItem>
