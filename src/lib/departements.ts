// Correspondance code département -> nom. Utilisé pour n'afficher que le
// département des biens (confidentialité : pas de commune/CP en public).
export const DEPARTEMENTS: Record<string, string> = {
  "01": "Ain", "02": "Aisne", "03": "Allier", "04": "Alpes-de-Haute-Provence",
  "05": "Hautes-Alpes", "06": "Alpes-Maritimes", "07": "Ardèche", "08": "Ardennes",
  "09": "Ariège", "10": "Aube", "11": "Aude", "12": "Aveyron", "13": "Bouches-du-Rhône",
  "14": "Calvados", "15": "Cantal", "16": "Charente", "17": "Charente-Maritime",
  "18": "Cher", "19": "Corrèze", "20": "Corse", "2A": "Corse-du-Sud", "2B": "Haute-Corse",
...
export function departementLabel(code: string | null | undefined): string {
  if (!code) return "France";
  const nom = DEPARTEMENTS[code];
  return nom ? `${nom} (${code})` : `Dép. ${code}`;
}
